...
const Home: NextPage<Props> = () => {
  ...
  return (
    <>
      <Head>
        <title>Regístrate | EncuestApp</title>
        <meta
          name="description"
          content="REGÍSTRATE Y EMPIEZA A CREAR Y PROCESAR ENCUESTAS | EncuestApp"
        />
      ...
      <main>
            ...
            >
              ...
              <defs>
                <linearGradient
                  ...
                  gradientUnits="userSpaceOnUse"
                >
                  <stop stopColor="#A19AFD" />
                  <stop offset={1} stopColor="#DD92B4" />
                </linearGradient>
              </defs>
            </svg>
          </div>
        ...
        <div className="flex flex-col-reverse  md:h-screen md:flex-row">
          ...
          <div className="flex min-h-screen items-center justify-center py-20 md:w-1/2 ">
            <Auth
              title="Regístrate"
              linkText="¿ya estás registrado? inicia sesión aquí"
